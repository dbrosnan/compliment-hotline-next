...
var BuildId = "kvMM_r6mmdfPVu7V3q0jr";
var HtmlPages = ["/404", "/500"];
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "priority": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_global-error", "regex": "^/_global\\-error(?:/)?$", "routeKeys": {}, "namedRegex": "^/_global\\-error(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/api/admin/approve", "regex": "^/api/admin/approve(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/approve(?:/)?$" }, { "page": "/api/admin/login", "regex": "^/api/admin/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/login(?:/)?$" }, { "page": "/api/admin/queue", "regex": "^/api/admin/queue(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/queue(?:/)?$" }, { "page": "/api/admin/reject", "regex": "^/api/admin/reject(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/admin/reject(?:/)?$" }, { "page": "/api/compliments/audio/finalize", "regex": "^/api/compliments/audio/finalize(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/compliments/audio/finalize(?:/)?$" }, { "page": "/api/compliments/audio/init", "regex": "^/api/compliments/audio/init(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/compliments/audio/init(?:/)?$" }, { "page": "/api/compliments/audio/upload", "regex": "^/api/compliments/audio/upload(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/compliments/audio/upload(?:/)?$" }, { "page": "/api/compliments/recent", "regex": "^/api/compliments/recent(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/compliments/recent(?:/)?$" }, { "page": "/api/compliments/stats", "regex": "^/api/compliments/stats(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/compliments/stats(?:/)?$" }, { "page": "/api/compliments/text", "regex": "^/api/compliments/text(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/compliments/text(?:/)?$" }, { "page": "/favicon.ico", "regex": "^/favicon\\.ico(?:/)?$", "routeKeys": {}, "namedRegex": "^/favicon\\.ico(?:/)?$" }], "dynamic": [{ "page": "/api/admin/audio/[id]", "regex": "^/api/admin/audio/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/admin/audio/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/compliments/[id]/audio", "regex": "^/api/compliments/([^/]+?)/audio(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/compliments/(?<nxtPid>[^/]+?)/audio(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
...
var AppPathRoutesManifest = { "/_global-error/page": "/_global-error", "/_not-found/page": "/_not-found", "/api/admin/approve/route": "/api/admin/approve", "/api/admin/audio/[id]/route": "/api/admin/audio/[id]", "/api/admin/login/route": "/api/admin/login", "/api/admin/queue/route": "/api/admin/queue", "/api/admin/reject/route": "/api/admin/reject", "/api/compliments/[id]/audio/route": "/api/compliments/[id]/audio", "/api/compliments/audio/finalize/route": "/api/compliments/audio/finalize", "/api/compliments/audio/init/route": "/api/compliments/audio/init", "/api/compliments/audio/upload/route": "/api/compliments/audio/upload", "/api/compliments/recent/route": "/api/compliments/recent", "/api/compliments/stats/route": "/api/compliments/stats", "/api/compliments/text/route": "/api/compliments/text", "/favicon.ico/route": "/favicon.ico", "/page": "/" };
